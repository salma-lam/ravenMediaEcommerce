...
<html lang="en">
    ...
    <body>
       ...
       <div class="nav">
        ...
        <!-- Breadcrumb End -->
                            <!-- Side Bar Start dyql lte7t li z9e3 fihq prbl;-->
                        ...
                        <div class="sidebar-widget category">
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="product-list.php?designation='femme'" ><i class="fa fa-female"></i>Femme</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="product-list.php?designation='homme'" ><i class="fa fa-child"></i>Homme</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="product-list.php?designation='enfant'" ><i class="fa fa-tshirt"></i>Enfant</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="product-list.php?designation='accessoire'" ><i class="fa fa-shopping-bag"></i>Accessoires</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                $req="select*from produit where date between '2022-06-01' and '2022-06-30'";
                                $res=$cnx->query($req);
                               // echo $req;
                              ...
                              <div class='product-item'>
                                  ...
                                  <div class='product-image'>
                                        <a href='product-detail.php'>
                                            <img src='women/<?=$data['photo']?>' alt='Product Image' width='300px' height='300px'>
                                        </a>
                                    </div>
                                    <div class='product-price'>
