...
<?php 
   ...
   if (isset($_POST['inscrir'])) {          
    ...
    $data1=$res1->fetch_assoc();
        if($res1->num_rows==0){
           $req="INSERT INTO client (nom,prenom,adresse,ville,pays,email,motPasse,telephone)VALUES('$n','$p','$a','$v','$pa','$e','$pw',$t)";
           $res=$cnx->query($req);
                    //echo $res;
             if($res){
                    ...
                    <div class="col-lg-6">    
                        <div class="register-form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="submit" class="btn" name="inscrir" value="S'inscrire">
                                </div>
                            </div>
                        </div>
                    </div>
